...
async def register(user_in: UserRegister):
    ...
    return {"access_token": token, "token_type": "bearer", "user_email": new_user.email, "is_admin": False}
...
async def login(form_data: UserLogin):
    ...
    return {"access_token": token, "token_type": "bearer", "user_email": user.email, "is_admin": user.is_admin}
...
async def change_role(user_id: str, is_admin: bool, admin: Annotated[User, Depends(get_current_admin_user)]):
